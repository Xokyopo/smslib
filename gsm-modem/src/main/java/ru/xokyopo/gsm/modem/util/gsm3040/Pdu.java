...
package ru.xokyopo.gsm.modem.util.gsm3040;

import ru.xokyopo.gsm.modem.entity.MsIsdn;
import ru.xokyopo.gsm.modem.util.gsm3040.ie.ConcatInformationElement;
import ru.xokyopo.gsm.modem.util.gsm3040.ie.InformationElement;
import ru.xokyopo.gsm.modem.util.gsm3040.ie.PortInformationElement;
...
public abstract class Pdu {
    ...
    public void setAddress(MsIsdn address) {
        if (address.getType() == MsIsdn.Type.Void) this.address = "";
